...
def main():
    ...
    base_path = input("Enter the base path where folders should be created: ").strip()  # Strip whitespace
    start_version = input("Enter the starting version (e.g., 'ver-1-0-0_alpha-1'): ").strip()  # Strip whitespace
    count = int(input("How many folders should be created? ").strip())  # Strip whitespace
